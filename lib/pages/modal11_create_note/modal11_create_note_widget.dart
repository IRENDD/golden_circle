            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<EventsCollectionRecord>>(
                    stream: queryEventsCollectionRecord(
                      singleRecord: true,
                    ),
                    builder: (context, snapshot) {
                      ...
                      List<EventsCollectionRecord>
                          textEventsCollectionRecordList = snapshot.data!;
                      // Return an empty Container when the item does not exist.
                      if (snapshot.data!.isEmpty) {
                        return Container();
                      }
                      final textEventsCollectionRecord =
                          textEventsCollectionRecordList.isNotEmpty
                              ? textEventsCollectionRecordList.first
                              : null;
                      return Text(
                        valueOrDefault<String>(
                          textEventsCollectionRecord?.eventName,
                          'eventName',
                        ),
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<EventsCollectionRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Text(
                        valueOrDefault<String>(
                          textEventsCollectionRecord?.eventDetails,
                          'eventID',
                        ),
                        maxLines: 69,
